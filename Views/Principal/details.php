                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga totam distinctio, esse accusamus cum quos magnam sequi necessitatibus architecto? Voluptatum quaerat omnis delectus praesentium eum, vel obcaecati fugiat sequi maiores.</li>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            ...
                                            <li class="list-inline-item"><span class="btn btn-success btn-size">Libra</span></li>
                                            <li class="list-inline-item"><span class="btn btn-success btn-size">Kilo</span></li>
                        ...
                        <div class="card rounded-0">
                            ...
                            <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled">
                                    ...
                                    <li><a class="btn btn-success text-white mt-2" href="<?php echo BASE_URL .'principal/details/' . $relacion['id']; ?>"><i class="fa fa-eye"></i></a></li>
                                    <li><a class="btn btn-success text-white mt-2" href="#"><i class="fa fa-cart-plus"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                            <a href="<?php echo BASE_URL .'principal/details/' . $relacion['id']; ?>" class="h3 text-decoration-none"><?php echo $relacion['nombre']; ?></a>
